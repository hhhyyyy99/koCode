# tui-expandable-transcript-blocks Specification

## Purpose
Unified expandable transcript block model for thinking blocks and tool cards: shared keys, Ctrl+O expand/collapse, and focus navigation.
